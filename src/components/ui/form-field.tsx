...
export function FormInput({ label, error, required = false, className, ...props }: FormInputProps) {
  return (
    <FormField label={label} id={props.id || ""} error={error} required={required}>
      <Input
        {...props}
        className={cn(
...
export function FormTextarea({ label, error, required = false, className, ...props }: FormTextareaProps) {
  return (
    <FormField label={label} id={props.id || ""} error={error} required={required}>
      <Textarea
        {...props}
