          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <Label className="text-sm">
                ...
                interest and dividends, court order for child support, alimony,
                royalties, agricultural subsidies, gambling income, oil credits,
                rent subsidies, sharing economy income, etc.
              </Label>
            </div>
            <div className="flex items-start space-x-3">
              <Checkbox className="data-[state=checked]:bg-[#22b573] data-[state=checked]:border-[#22b573] mt-1" />
              <Label className="text-sm">
                Copies of individual complete bank statements for the three most
                recent months. If you operate a business, copies of the six most
                recent complete statements for each business bank account.
              </Label>
            </div>
            <div className="flex items-start space-x-3">
              <Checkbox className="data-[state=checked]:bg-[#22b573] data-[state=checked]:border-[#22b573] mt-1" />
              <Label className="text-sm">
                ...
                Businesses) if you or your spouse have an interest in a business
            ...
            <div className="flex items-start space-x-3">
              <Checkbox className="data-[state=checked]:bg-[#22b573] data-[state=checked]:border-[#22b573] mt-1" />
              <Label className="text-sm">
                Copies of the most recent statement from lender(s) on loans such
                as mortgages, second mortgages, vehicles, etc., showing monthly
            ...
            <div className="flex items-start space-x-3">
              <Checkbox className="data-[state=checked]:bg-[#22b573] data-[state=checked]:border-[#22b573] mt-1" />
              <Label className="text-sm">
                Documentation to support any special circumstances described in
                the "Explanation of Circumstances" on Form 656, if applicable.
              </Label>
            </div>
            <div className="flex items-start space-x-3">
              <Checkbox className="data-[state=checked]:bg-[#22b573] data-[state=checked]:border-[#22b573] mt-1" />
