                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormInput
                          ...
                          error={
                            errors.otherBusinesses?.[index]?.title?.message
                          }
                        />
                      </div>
                      ...
                      <FormInput
                        ...
                        error={
                          errors.otherBusinesses?.[index]?.businessAddress
                            ?.message
                        }
                      />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <FormInput
                          ...
                          error={
                            errors.otherBusinesses?.[index]?.businessName
                              ?.message
                          }
                        />
                        <FormInput
                      ...
                      >
                        <RadioGroup
                          ...
                          onValueChange={(value) =>
                            setValue(
                              `otherBusinesses.${index}.businessType`,
                              value
                            )
                          }
